...
const Website = () => {
  ...
  const filterOptions = [
    ...
    { value: 'সংবাদ', label: 'সংবাদ' },
    { value: 'শিক্ষা', label: 'শিক্ষা' },
    { value: 'ব্যবসা', label: 'ব্যবসা' },
    { value: 'স্বাস্থ্য', label: 'স্বাস্থ্য' },
    { value: 'কৃষি', label: 'কৃষি' },
    { value: 'পর্যটন', label: 'পর্যটন' },
    { value: 'ই-কমার্স', label: 'ই-কমার্স' },
    { value: 'সামাজিক', label: 'সামাজিক' },
    { value: 'প্রযুক্তি', label: 'প্রযুক্তি' }
  ];
    ...
    <div className="min-h-screen bg-white font-bengali">
      ...
      <div className="pt-14 pb-20">
        ...
        <SearchAndFilter
          ...
          placeholder="ওয়েবসাইট নাম বা ধরন খুঁজুন..."
          ...
          <div className="grid gap-3">
            {filteredWebsites.length > 0 ? (
              filteredWebsites.map((website) => (
                <div key={website.id} className="bg-white rounded-lg shadow-sm border border-gray-100 p-4 hover:shadow-md transition-shadow">
                  ...
                  <div className="space-y-2 text-sm text-gray-600">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        ...
                        <a href={`tel:${website.phone}`} className="text-blue-600 hover:underline">{website.phone}</a>
                      </div>
